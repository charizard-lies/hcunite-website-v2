...
<!-- hero section -->
    <section class="mt-30 pb-12">
        <h1 class="z-20 text-black lg:text-8xl w-full text-center">49TH STUDENTS' COUNCIL</h1>
        <div class="w-full h-screen relative">
            <img src="/images/49th/49th_HCSC.jpg" alt="background" class="z-0 absolute w-full h-full object-cover">
        </div>
        <div class="p-6">
